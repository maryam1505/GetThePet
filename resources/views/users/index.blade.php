                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            Once you've found the perfect pet, just add them to your cart and proceed to
                                            checkout! Keep track of your pet's health and behavior with our pet history
                                            feature, and stay updated on upcoming events in the pet community.
                                        </p>
                                        <div class="btn-box">
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            You can shop for pets in our marketplace, . Once you've found the perfect pet,
                                            just add them to your cart and proceed to checkout! Keep track of your pet's
                                            health and behavior with our pet history feature, and stay updated on upcoming
                                            events in the pet community
                                        </p>
                                        <div class="btn-box">
                                            <a href="{{ Route('about') }}" class="btn-1">
                                                Read More
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            Offers a wide range of medications and healthcare services. We provide online
                                            prescription refills, home delivery, and expert consultations. Our goal is to
                                            make healthcare simple, accessible, and reliable for you."
                                        </p>
                                        <div class="btn-box">
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            Offers a variety of high-quality pet accessories to keep your furry friends
                                            happy and healthy. From cozy beds and stylish collars to fun toys and nutritious
                                            treats, we have everything you need for your pets. Shop with us for affordable,
                                            reliable, and stylish pet products.
                                        </p>
                                        <div class="btn-box">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            Your go-to place for engaging discussions and community support. Join us to
                                            share ideas, ask questions, and connect with others who share your interests.
                                            Whether you're looking for advice, information, or friendly conversation, our
                                            forum is the perfect place to be...
                                        </p>
                                        <div class="btn-box">
    ...
    <section class="layout_padding-bottom py-5">
        <div class="container">
            ...
            <div class="owl-carousel product-carousel">
                ...
                @if($loop->last)
                    <div class="pb-5 last-slide">
                        <div class="product-item position-relative bg-light d-flex flex-column text-center">
                            <img class="img-fluid mb-4" src="{{ asset('storage/' . $product->image) }}" alt="product">
                            <h6 class="text-uppercase">{{ $product->name }}</h6>
                            <h5 class="text-primary mb-0 text-uppercase">{{ $product->currency }} {{ $product->price }}
                            </h5>
                        </div>
                        <div class="show-more-overlay">
                            <a class="btn btn-primary py-2 px-3" href="{{ route('accessory.food') }}">Show More</a>
                        </div>
                    </div>
                @else
                    <div class="pb-5">
                ...
                <div class="col-md-6 mb-3">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <a class="text-primary text-uppercase" href="{{ Route('about') }}">Read More<i
                ...
                <div class="col-md-6 mb-3">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>Offers a wide selection of premium pet food to keep your furry friends healthy and happy...
                            </p>
                            <a class="text-primary text-uppercase" href="{{ Route('about') }}">Read More<i
                                    class="bi bi-chevron-right"></i></a>
                        </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="service-item bg-light d-flex p-4">
                        ...
                        <div>
                            ...
                            <p>Provides top-notch pet grooming services to keep your furry friends looking and feeling their
                                best...</p>
                            <a class="text-primary text-uppercase" href="{{ Route('about') }}">Read More<i
                                    class="bi bi-chevron-right"></i></a>
                        </div>
                    ...
                    <div class="owl-carousel team-carousel position-relative" style="padding-right: 25px;">
                        <div class="team-item">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('users/template/img/team-1.jpg') }}"
                                    alt="">
                        ...
                        <div class="team-item">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('users/template/img/team-2.jpg') }}"
                                    alt="">
                                <div class="team-overlay">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <a class="btn btn-light btn-square mx-1" href="#"><i
                        ...
                        <div class="team-item">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('users/template/img/team-3.jpg') }}"
                                    alt="">
                                <div class="team-overlay">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <a class="btn btn-light btn-square mx-1" href="#"><i
                        ...
                        <div class="team-item">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('users/template/img/team-4.jpg') }}"
                                    alt="">
                                <div class="team-overlay">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <a class="btn btn-light btn-square mx-1" href="#"><i
                        ...
                        <div class="team-item">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('users/template/img/team-5.jpg') }}"
                                    alt="">
                                <div class="team-overlay">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <a class="btn btn-light btn-square mx-1" href="#"><i
